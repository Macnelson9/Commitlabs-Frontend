...
export const HeroSection: React.FC = () => {
  return (
    <div className="min-h-screen w-full py-10 bg-[#0a0a0a] flex items-center justify-center overflow-hidden">
      <div className="relative w-full aspect-[1680/823.333]">
        {/* Stars */}
        <StarField />

        {/* Content */}
        <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-8 lg:px-0">
          <div className="relative w-fit flex flex-col items-center">
            {/* Logo & Title */}
            <div className="flex items-center justify-center gap-3 sm:gap-4 mb-8">
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center pt-1">
                ...
                <p className="relative font-mono font-normal text-white text-lg sm:text-xl lg:text-2xl leading-8 text-center z-10">
                  C
                </p>
              </div>
              <div className="flex items-center pt-2">
                <h1 className="font-mono font-medium text-[#f5f5f7] text-2xl sm:text-3xl lg:text-[30px] leading-9">
                  CommitLabs
                </h1>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center mb-6">
              <h2 className="font-['Inter',sans-serif] font-bold text-3xl sm:text-5xl xl:text-[85px] leading-tight text-center bg-clip-text text-transparent bg-linear-to-b from-white to-[#99a1af]">
                Liquidity as a
              </h2>
              <h2 className="font-['Inter',sans-serif] font-bold text-3xl sm:text-5xl xl:text-[85px] leading-tight text-center bg-clip-text text-transparent bg-linear-to-b from-[#0ff0fc] to-[#0a7a82]">
                commitment,
              </h2>
              <h2 className="font-['Inter',sans-serif] font-bold text-3xl sm:text-5xl xl:text-[85px] leading-tight text-center bg-clip-text text-transparent bg-linear-to-b from-white to-[#99a1af]">
                not a guess.
            ...
            {/* Description */}
            <p className="font-['Inter',sans-serif] font-normal text-[#99a1af] text-base sm:text-lg lg:text-2xl leading-relaxed lg:leading-9.75 text-center max-w-176.25 mb-2 tracking-[0.0703px] px-4">
